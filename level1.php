...
<html lang="en">
   ...
   <body>
      ...
      <div class="container">
         <div class="row">
            <?php 
               $query="select * from puzzle where level='Easy'";
               if( $query_run = mysqli_query($con,$query) )  
               {
            ...
            <div class="col-sm-6">
               <div class="panel panel-success">
                  ...
                  <div class="panel-footer"><button type="button" class="btn btn-warning">Evaluation Pending</button></div>
                  <?php
                     }
                  ...
                  <?php
                     ...
                     {
                     ?>
                  <a href="showpuzzle.php?id= <?php echo $row["id"]; ?>&status=<?php echo $row3['status'];?>&level=level1">
                  ...
                  <?php
                     ...
                     {
                     ?>
                  <div class="panel-footer"><a href="showpuzzle.php?id= <?php echo $row["id"]; ?>&status=<?php echo $row3['status'];?>&level=level1"><button type="button" class="btn btn-primary btn-md" >Try Now</button></a></div>
                  <?php
                     }
                     else
                     {
                      ?>
                  <div class="panel-footer"><a href="showpuzzle.php?id= <?php echo $row["id"]; ?>&status=<?php echo $row3['status'];?>&&level=level1"><button type="button" class="btn btn-primary btn-md" >Show Puzzle</button></a></div>
                  <?php
                     }
                     ?>
               </div>
      ...
      <?php
         header("Refresh:0; url=http://puzzlepedia.esy.es/level1.php"); 
      ...
      <?php
         header("Refresh:0; http://puzzlepedia.esy.es/level1.php");
