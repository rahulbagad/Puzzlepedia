...
<html lang="en">
   ...
   <body>
      ...
      <div class="container">
         <div class="row">
            <?php 
               $query="select * from puzzle where level='Moderate'";
               if( $query_run = mysqli_query($con,$query) )  
               {
            ...
            <div class="col-sm-6">
               <div class="panel panel-success">
                  ...
                  <?php
                     ...
                     {
                     ?>
                  <a href="showpuzzle.php?id= <?php echo $row["id"]; ?>&status=<?php echo $row3['status'];?>&level=level2">
                  ...
                  <?php
                     ...
                     {
                     ?>
                  <div class="panel-footer"><a href="showpuzzle.php?id= <?php echo $row["id"]; ?>&status=<?php echo $row3['status'];?>&level=level2"><button type="button" class="btn btn-primary btn-md" >Try Now</button></a></div>
                  <?php
                     }
                     else
                     {
                      ?>
                  <div class="panel-footer"><a href="showpuzzle.php?id= <?php echo $row["id"]; ?>&status=<?php echo $row3['status'];?>&level=level2"><button type="button" class="btn btn-primary btn-md" >Show Puzzle</button></a></div>
                  <?php
                     }            ?>
               </div>
            </div>
